...
#'
#' @description Generates a 2D mesh object using the convex hull, concave_hull, or raster_mask of the species presences/absences (plus optional new scenario rasters), from a processed \code{nsdm.vinput} object (output of \code{\link[sabinaNSDM]{NSDM.SelectCovariates}}).
#'
